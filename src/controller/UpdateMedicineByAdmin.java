...
/**
 * Servlet implementation class UpdateMedicineByAdmin
 */
@WebServlet("/UpdateMedicineByAdmin")
public class UpdateMedicineByAdmin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		i=dao.UpdateMedicineByAdmin(mb);
		if(i>0) {
		//out.print("Updated");	
