...
/**
 * Servlet implementation class InsertColonscrpyByAdmin
 */
@WebServlet("/InsertColonscrpyByAdmin")
public class InsertColonscrpyByAdmin extends HttpServlet {
     ...
     */
    public InsertColonscrpyByAdmin() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("HELLO");  
		i=dao.InsertColonscorpyByAdmin(mb);
		if(i>0) {
